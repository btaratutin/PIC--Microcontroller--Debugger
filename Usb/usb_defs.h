/*
	The header/definition file for the usb code.
	Again, not important to worry about unless you're rewriting the low-level usb-pic protocol
*/
...
#ifndef usb_buffer_descriptor
#define usb_buffer_descriptor
